...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        # ends the script if user types end
        if choice == 'end':
            raise SystemExit
...
def get_filters():
    ...
    while True:
        city = choice("\nWould you like to see data for "
                      ...
                      "to list the names.\n>", CITY_DATA.keys())
        month = choice("\nDo you "
                       "want to filter the data by month (January - June)? Use commas to list the names.\n>",
                       months)
        day = choice("\nFor what weekday(s) do you want to filter the "
